...
| `char_code(s) -> i64`               | First Unicode CODEPOINT of `s` as an integer (`char_code("é")` = 233, not the byte 195). Inverse of `char_from`. For a raw byte use `byte_at(s, 0)`. |
