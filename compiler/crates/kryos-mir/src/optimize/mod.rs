...
//! 3. **DCE** — remove unreachable blocks and dead assignments.
//! 4. **TCO** — convert tail-recursive calls to loops.
...
/// constants), then fold, then clean up dead code, convert tail calls, and
/// finally reduce strength of remaining operations.
