...
// Generated by build.rs: `native_symbols()` -- every #[no_mangle]
// extern "C" symbol in this crate, for bulk JIT registration.
include!(concat!(env!("OUT_DIR"), "/native_symbols.rs"));
