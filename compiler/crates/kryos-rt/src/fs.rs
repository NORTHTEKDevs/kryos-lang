...
pub unsafe extern "C" fn kryos_fs_read(
    ...
    let path = std::str::from_utf8_unchecked(std::slice::from_raw_parts(path_ptr, path_len));
...
pub unsafe extern "C" fn kryos_fs_write(
    ...
    let path = std::str::from_utf8_unchecked(std::slice::from_raw_parts(path_ptr, path_len));
    let data = std::str::from_utf8_unchecked(std::slice::from_raw_parts(data_ptr, data_len));
