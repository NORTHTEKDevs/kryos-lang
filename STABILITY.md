...
Last updated: 2026-07-06 (v1.0.0-beta.4).
...
## 4. Current pass rates (v1.0.0-beta.4)
...
## 5. Known limitations (v1.0.0-beta.4)

There are no architectural failures in the release-gating sweep at
v1.0.0-beta.4. The v2.1 "known limitations" listed below were all closed in
